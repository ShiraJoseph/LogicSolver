...
/** An option label on the top or left axis, and the values its base-header needs. */
@Component({
  selector: 'app-option',
...
export class OptionComponent extends BaseDirective {
  ...
  /** The base-header type string, opening with the option's feature name. */
  ...
  /** If this is the top axis option base-header */
